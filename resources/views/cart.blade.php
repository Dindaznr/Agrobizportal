        ...
        <table id="cart" class="table table-hover table-condensed" style="margin-top: 100px;">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td data-th="Subtotal" class="text-center">{{ number_format($details['total']) }}</td>
            ...
            <tfoot>
                ...
                <tr>
                    ...
                    <td><a href="{{ route('checkout') }}" class="btn btn-success btn-block">Proses Checkout <i class="fa fa-angle-right"></i></a></td>
                </tr>
            </tfoot>
        </table>
    </div>
